...
export default function IndieBooksPage() {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            // 2. Fetch Indie Books (Early Access)
            const { data: eaBooks } = await supabase
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="py-8 animate-fade-in">
                        ...
                        <p className="mt-2 text-fade">
                            Descubra talentos independentes e apoie novos autores
                        </p>
                    </div>
                    ...
                    {!loading && filteredBooks.length === 0 && (
                        <div className="text-center py-16">
                            <p className="text-fade text-lg">
                                Nenhum livro indie encontrado.
                            </p>
                            {books.length === 0 ? (
                                <p className="text-sm text-fade mt-2">
                                    Ainda não há livros independentes publicados. Seja o primeiro!
                                </p>
                            ) : (
                                <Button
                                    variant="ghost"
